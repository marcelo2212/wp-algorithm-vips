...
class Woo_Slider extends Widget_Base {
    ...
    public function render() {
		...
		$slides_tablet = isset($settings['slides_to_show_tablet']) ? $settings['slides_to_show_tablet'] : '';
		$slides_mobile = isset($settings['slides_to_show_mobile']) ? $settings['slides_to_show_mobile'] : '';
